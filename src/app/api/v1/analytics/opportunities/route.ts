...
export async function GET(request: NextRequest) {
  try {
    ...
    const data = await intelligenceAnalyticsService.getPricingOpportunityAnalytics(auth.context.orgId, {
      competitorId,
      productId,
    ...
    const message = error instanceof Error ? error.message : 'Failed to fetch pricing opportunity analytics';
